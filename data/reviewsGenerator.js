...
const generateReview = (listing_id) => {
    ...
    return `${listing_id},${customer_id},${review},${review_date},${cleanliness},${communication},${check_in},${accuracy},${location_review},${value_review}\n`
};
...
stream.write(`listing_id,customer_id,review,review_date,cleanliness,communication,check_in,accuracy,location_review,value_review\n`, 'utf-8')
startWriting(stream, 'utf-8', () => {
stream.end()
})

// node reviewsGenerator.js --lines 20 --output sample_reviews.csv
// wc -l reviews.csv