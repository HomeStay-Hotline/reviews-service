...
const filename = argv.output || 'arango_reviews_customers.csv';
...
const generateReview = (listing_id, review_id) => {
    ...
    return `${review_id},${listing_id},${customer_name},${photo_url},${review},${review_date},${cleanliness},${communication},${check_in},${accuracy},${location_review},${value_review}\n`
};
...
stream.write(`review_id,listing_id,customer_name,photo_url,review,review_date,cleanliness,communication,check_in,accuracy,location_review,value_review\n`, 'utf-8')
